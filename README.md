...
**To deploy frontend and backend as two separate projects** (e.g. frontend on Vercel, backend on Railway/Render/Fly.io), see **[docs/DEPLOY_TWO_PROJECTS.md](docs/DEPLOY_TWO_PROJECTS.md)**. **Backend on Vercel:** see **[docs/VERCEL_BACKEND.md](docs/VERCEL_BACKEND.md)** for commands and setup.
